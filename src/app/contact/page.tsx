...
import { Mail, MessageCircle, Globe, MapPin, Clock, Users, Github, Trophy, Instagram, ExternalLink } from "lucide-react";
...
export default function ContactPage() {
  ...
  const externalLinks = [
    ...
    },
    {
      ...
      icon: Instagram,
      title: "Instagram",
      description: "@flagaholichk",
      href: "https://www.instagram.com/flagaholichk"
    },
    {
      id: "discord",
      icon: MessageCircle,
      ...
      href: "https://discord.gg/mPqDsmQWJV"
    },
    {
      id: "website",
      icon: Globe,
      title: "Website",
      description: "flagaholic.xyz",
      ...
      <div className="relative z-10 container mx-auto px-4 py-32">
        ...
        >
          ...
          <CodeHoverCards
            ...
            showBorder={true}
            onCardClick={(card) => {
              const link = externalLinks.find(l => l.id === card.id);
        ...
        <motion.div
          ...
          className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 mb-16"
        >
          <GlassCard className="p-6 text-center hover:shadow-lg transition-shadow">
            <Mail className="h-8 w-8 text-warm-gold mx-auto mb-4" />
            <h3 className="text-xl font-bold text-text-primary mb-2">Email</h3>
            <a
              href={`mailto:${teamInfo.email}`}
              className="text-warm-gold hover:text-warm-gold/80 break-all"
            >
              {teamInfo.email}
            </a>
          </GlassCard>
          ...
          <GlassCard className="p-6 text-center hover:shadow-lg transition-shadow">
            <MessageCircle className="h-8 w-8 text-warm-gold mx-auto mb-4" />
            <h3 className="text-xl font-bold text-text-primary mb-2">Discord</h3>
            <a
              href="https://discord.gg/mPqDsmQWJV"
              target="_blank"
              rel="noopener noreferrer"
              className="text-warm-gold hover:text-warm-gold/80 flex items-center justify-center gap-1"
            >
              Join Server
          ...
          <GlassCard className="p-6 text-center hover:shadow-lg transition-shadow">
            <Instagram className="h-8 w-8 text-warm-gold mx-auto mb-4" />
            <h3 className="text-xl font-bold text-text-primary mb-2">Instagram</h3>
            <a
              href="https://www.instagram.com/flagaholichk"
              target="_blank"
              rel="noopener noreferrer"
